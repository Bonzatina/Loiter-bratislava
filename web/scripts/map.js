const { pages: allPages, routes, colors, domainColors, legendTypes, legendColors, lang, ui } = window.DATA
...
const wikiBase = lang === 'en' ? '/en' : ''
const mapBase  = lang === 'en' ? '/en' : '/'
...
const map = L.map('map', { boxZoom: false }).setView([48.1447, 17.1098], 13)
...
const STATE_KEY = 'bratislava_map_state_v1'
